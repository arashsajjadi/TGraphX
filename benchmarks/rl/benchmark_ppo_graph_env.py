"""Benchmark PPO on GraphNavigationEnv.
...
def parse_args():
    p = argparse.ArgumentParser(description="Benchmark PPO on GraphNavigationEnv")
...
def main():
    ...
    if args.json:
        ...
        print(f"PPO benchmark ({result['episodes']} episodes)")
